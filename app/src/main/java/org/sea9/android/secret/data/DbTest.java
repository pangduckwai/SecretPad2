...
//	private void test005(DbHelper helper) {
//		List<NoteRecord> list = DbContract.Notes.Companion.select(helper);
//		StringBuilder builder = new StringBuilder("Notes:");
//		builder.append('\n');
//		for (NoteRecord record : list) {
//			builder.append(record.getKey()).append('\n');
//		}
//		Log.w("secret.db_test005", builder.toString());
//	}
